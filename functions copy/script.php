...
function teamswitch_adding_scripts($google_maps_link) {  
	...
	wp_enqueue_script('nav', get_template_directory_uri() . '/js/nav.js', array('jquery'), filemtime(get_stylesheet_directory() . '/js/nav.js'));
	wp_enqueue_script('scroll', get_template_directory_uri() . '/js/scroll.js', array(), filemtime(get_stylesheet_directory() . '/js/scroll.js'));
}
